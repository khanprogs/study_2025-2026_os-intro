...
subtitle: "Введение"
author: "Хан Георгий Игоревич, НКА-бд-06-25"
...
Я создал документ, и перед сохранением выбрал нужный формат, а после прикрепил его к курсу. Прикрепленный файл видно на скриншоте.
...
Здесь на скриншоте видно, что установив программу медиапроигрывателя я посмотрел, кто авторы программы и записал первую фамилию.
...
-q
--quiet
    Отключить вывод информации Wget.
